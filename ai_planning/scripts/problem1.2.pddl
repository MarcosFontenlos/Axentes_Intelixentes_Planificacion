(define (problem turtlebot_zigzag)
    ...
    (:objects
        wp00 wp01 wp02 wp03 wp10 wp11 wp12 wp13 wp20 wp21 wp22 wp23 wp30 wp31 wp32 wp33 - waypoint ;; Definimos todos los waypoints.
    ...
    (:goal
        (at turtlebot wp33)  ;; El objetivo es que el robot llegue a wp31.
    )
)
